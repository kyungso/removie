...
export default withRouter(({ location, movieResults, tvResults, collectionResults }) => (
    <header className={cx('searchTab-container')}>
        <ul className={cx('searchTab')}>
            ...
            >
                <Link to="/search" className={cx('searchTab-link')}>Movies ({movieResults.length})</Link>
            </li>
            <li className={cx('searchTab-item')} 
            ...
            >
                <Link to="/search/tv_result" className={cx('searchTab-link')}>TV Shows ({tvResults.length})</Link>
            </li>
            <li className={cx('searchTab-item')} 
            ...
            >
                <Link to="/search/collection_result" className={cx('searchTab-link')}>Collections ({collectionResults.length})</Link>
            </li>
        </ul>
    </header>
));
