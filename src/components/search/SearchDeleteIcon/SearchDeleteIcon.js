...
const SearchDeleteIcon = () => (
  <svg width="36px" height="36px" 
       ...
       style={{ display: `block`,
                ...
                height: `100%` }}
  >
    <title>Icons_Search_Delete</title>
    <desc>Created with Sketch.</desc>
    <g id="Icons_Search_Delete"
       stroke="none"
       strokeWidth="1"
       fill="none"
       fillRule="evenodd">
